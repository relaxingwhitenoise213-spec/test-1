# 📋 Quran & Athan — FULL ASO, copy & paste (US · UK · Arabic · Indonesian)

No-brand, all-keyword titles. Every field verified against Apple's limits
(Title 30 · Subtitle 30 · Keywords 100 · Promo 170 · Description 4000).
In App Store Connect: App Store tab → pick the language → paste each field.

⚠️ Before you submit: (1) confirm your exact **app name** is unique on the App Store;
(2) fill the **Terms of Use** + **Privacy Policy** URLs; (3) delete the "Premium" block in
each description if your app has **no** subscription.
...
• Beautiful Athan (Adhan) notifications with a choice of muezzin voices
• Pre-adhan reminders so you never miss a salah
• Home Screen & Lock Screen widgets and Apple Watch support

HOLY QURAN
• Read the complete Quran in clear Uthmani script
• Listen to audio recitation from renowned reciters
• Translation and transliteration to help you read and understand
• Bookmarks and resume — works online or offline

QIBLA & MORE
• Accurate Qibla compass to find the direction of the Kaaba anywhere
• Hijri (Islamic) calendar with important dates
• Duas & Azkar for everyday moments
...
### Screenshot captions
```
1. Never miss a prayer — accurate Athan & times
2. The full Holy Quran, with audio
...
### Screenshot captions
```
1. Never miss namaz — accurate Athan & times
2. The full Holy Quran, with audio
3. Find the Qibla anywhere
4. Duas, Azkar & digital Tasbeeh
5. Hijri calendar & Ramadan times
...
═══════════════════════════════════════════════════════════════════
# 🇸🇦 ARABIC — العربية  (one listing serves ALL Arab storefronts · RTL)
═══════════════════════════════════════════════════════════════════
...
• تنبيهات أذان بأصوات نخبة من المؤذنين
• تذكير قبل الأذان حتى لا تفوتك الصلاة
• أدوات للشاشة الرئيسية وشاشة القفل ودعم Apple Watch

القرآن الكريم
• اقرأ القرآن كاملاً برسم عثماني واضح
• استمع إلى تلاوة القرآن بأصوات مشاهير القرّاء
• ترجمة وتفسير لفهم المعاني
• حفظ العلامات والمتابعة من حيث توقفت — يعمل بدون إنترنت

القبلة والمزيد
• بوصلة قبلة دقيقة لتحديد اتجاه الكعبة في أي مكان
• التقويم الهجري بالمناسبات المهمة
...
• Notifikasi adzan dengan pilihan suara muazin
• Pengingat sebelum adzan agar tidak terlewat
• Widget Layar Utama & Layar Kunci serta dukungan Apple Watch

AL-QURAN
• Baca Al-Quran lengkap dengan tulisan yang jelas
• Dengarkan murottal dari qari terkenal
• Terjemahan dan transliterasi bahasa Indonesia
• Penanda dan lanjutkan bacaan — online maupun offline

KIBLAT & LAINNYA
• Kompas kiblat akurat untuk menemukan arah Ka'bah di mana saja
• Kalender Hijriah dengan tanggal-tanggal penting
• Doa & dzikir harian
...
```
1. Jangan lewatkan sholat — jadwal & adzan akurat
2. Al-Quran lengkap dengan murottal
3. Temukan arah kiblat di mana saja
4. Doa, dzikir & tasbih digital
5. Kalender Hijriah & waktu Ramadhan
